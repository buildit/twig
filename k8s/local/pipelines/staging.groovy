...
k8s.build([containerTemplate(name: 'nodejs-builder', image: 'markadams/chromium-xvfb-js', ttyEnabled: true, command: 'cat', privileged: true, resourceRequestCpu: "1", resourceRequestMemory: "4096m")],
